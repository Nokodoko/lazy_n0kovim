...
-- HACK: blink.cmp updates | Remove LuaSnip | Emoji and Dictionary.cmdline.sources | Fix Jump Autosave Issue
-- https://youtu.be/JrgfpWap_Pg

-- completion plugin with support for LSPs and external.cmdline.sources that updates
...
return {
  ...
  opts = function(_, opts)
    ...
    -- Merge custom.cmdline.sources with the existing ones from lazyvim
    -- NOTE: by default lazyvim already includes the lazydev source, so not adding it here again
    opts.cmdline.sources = vim.tbl_deep_extend("force", opts.cmdline.sources or {}, {
      ...
      providers = {
        lsp = {
          name = "lsp",
          enabled = true,
          module = "blink.cmp.cmdline.sources.lsp",
          kind = "LSP",
        ...
        path = {
          name = "Path",
          module = "blink.cmp.cmdline.sources.path",
          score_offset = 25,
        ...
        buffer = {
          ...
          enabled = true,
          max_items = 3,
          module = "blink.cmp.cmdline.sources.buffer",
        ...
        snippets = {
          ...
          max_items = 15,
          min_keyword_length = 2,
          module = "blink.cmp.cmdline.sources.snippets",
